...
class PetersonRQuicksortWithBatcherEvenOddMergeMPI : public CoreAlgorithm {
 ...
 private:
  ...
  void TransmitDimensions(std::size_t &input_size, std::size_t &aligned_size);
  void DispatchData(const std::size_t &aligned_size, const std::vector<double> &prepared_input,
