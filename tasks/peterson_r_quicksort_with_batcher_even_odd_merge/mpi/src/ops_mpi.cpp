...
PetersonRQsortBatcherOddEvenMergeMPI::PetersonRQsortBatcherOddEvenMergeMPI(const InputArray &source) {
...
bool PetersonRQsortBatcherOddEvenMergeMPI::VerificationStep() {
  return GetOutput().empty();
}

bool PetersonRQsortBatcherOddEvenMergeMPI::PreparationStep() {
  return true;
}

bool PetersonRQsortBatcherOddEvenMergeMPI::ExecutionStep() {
...
void PetersonRQsortBatcherOddEvenMergeMPI::TransmitDimensions(size_t &input_size, size_t &aligned_size) {
  if (process_id_ == 0) {
...
void PetersonRQsortBatcherOddEvenMergeMPI::DispatchData(const size_t &aligned_size,
...
void PetersonRQsortBatcherOddEvenMergeMPI::CreateComparatorSet(std::vector<std::pair<int, int>> &comparators) const {
...
void PetersonRQsortBatcherOddEvenMergeMPI::BatcherSort(std::vector<int> &procs,
...
void PetersonRQsortBatcherOddEvenMergeMPI::BatcherMerge(std::vector<int> &procs,
                                                        std::vector<std::pair<int, int>> &comparators) {
  int n = procs.size();
  if (n <= 1) {
    return;
...
void PetersonRQsortBatcherOddEvenMergeMPI::ExecuteComparisons(
...
void PetersonRQsortBatcherOddEvenMergeMPI::CombineSegments(const std::vector<double> &local_values,
...
bool PetersonRQsortBatcherOddEvenMergeMPI::CompletionStep() {
  return true;
}
