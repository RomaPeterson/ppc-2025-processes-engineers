...
PetersonRQuicksortWithBatcherEvenOddMergeMPI::PetersonRQuicksortWithBatcherEvenOddMergeMPI(const InType &in) {
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::SendingVector(int rank) {
  int size_vec = 0;
  if (rank == 0) {
...
int PetersonRQuicksortWithBatcherEvenOddMergeMPI::LengthsLocalArrays(int size_arr, int rank, int size) {
...
std::vector<int> PetersonRQuicksortWithBatcherEvenOddMergeMPI::CalculatingInterval(int size_prcs, int rank,
                                                                                   int size_arr) {
...
std::pair<int, int> PetersonRQuicksortWithBatcherEvenOddMergeMPI::SplitRange(std::vector<int> &array, int left,
                                                                             int right) {
  int i = left;
  int j = right;
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::QuickSort(std::vector<int> &array) {
  if (array.empty()) {
    return;
  }
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::MergeAndSplit(std::vector<int> &own_data,
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::DataExchange(std::vector<int> &own_data, int size_arr, int rank,
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::EvenPhase(std::vector<int> &own_data, std::vector<int> &interval,
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::OddPhase(std::vector<int> &own_data, std::vector<int> &interval,
                                                            int size_arr, int rank, int size) {
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::BatcherOddEvenPhases(std::vector<int> &own_data,
...
void PetersonRQuicksortWithBatcherEvenOddMergeMPI::SendingResult(int rank) {
  int total_size = 0;
  if (rank == 0) {
