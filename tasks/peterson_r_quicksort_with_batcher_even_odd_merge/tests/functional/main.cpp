...
TEST_P(PetersonRQuicksortWithBatcherEvenOddMergeFuncTests, QuicksortWithBatcherEvenOddMerge) {
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<PetersonRQuicksortWithBatcherEvenOddMergeMPI, InType>(
                       kTestParam, PPC_SETTINGS_peterson_r_quicksort_with_batcher_even_odd_merge),
                   ppc::util::AddFuncTask<PetersonRQuicksortWithBatcherEvenOddMergeSEQ, InType>(
                       kTestParam, PPC_SETTINGS_peterson_r_quicksort_with_batcher_even_odd_merge));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = PetersonRQuicksortWithBatcherEvenOddMergeFuncTests::PrintFuncTestName<
    PetersonRQuicksortWithBatcherEvenOddMergeFuncTests>;

INSTANTIATE_TEST_SUITE_P(PetersonRQuicksortWithBatcherEvenOddMerge, PetersonRQuicksortWithBatcherEvenOddMergeFuncTests,
