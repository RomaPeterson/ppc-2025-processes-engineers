...
PetersonRQuicksortWithBatcherEvenOddMergeSEQ::PetersonRQuicksortWithBatcherEvenOddMergeSEQ(const InType &in) {
...
std::pair<int, int> PetersonRQuicksortWithBatcherEvenOddMergeSEQ::SplitRange(std::vector<int> &array, int left,
                                                                             int right) {
  int i = left;
  int j = right;
