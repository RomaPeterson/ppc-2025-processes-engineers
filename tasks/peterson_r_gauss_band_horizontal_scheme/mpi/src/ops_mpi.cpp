...
PetersonRGaussBandHorizontalSchemeMPI::PetersonRGaussBandHorizontalSchemeMPI(const InType &in) {
...
int PetersonRGaussBandHorizontalSchemeMPI::ValidateInput(const InType &input) {
  if (input.empty()) {
    return 0;
  }
...
void PetersonRGaussBandHorizontalSchemeMPI::DistributeRows(const InType &augmented_matrix, size_t n, size_t cols,
...
void PetersonRGaussBandHorizontalSchemeMPI::EliminateColumnMPI(InType &local_matrix,
...
size_t PetersonRGaussBandHorizontalSchemeMPI::GetGlobalIndex(const std::vector<int> &global_to_local, size_t local_idx,
                                                             size_t n) {
...
std::vector<double> PetersonRGaussBandHorizontalSchemeMPI::BackSubstitutionMPI(const InType &local_matrix,
