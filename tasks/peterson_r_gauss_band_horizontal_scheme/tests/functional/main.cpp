...
using PrintFuncType = std::string (*)(
    const ::testing::TestParamInfo<PetersonRGaussBandHorizontalSchemeRunFuncTestsProcesses::ParamType> &);
static const PrintFuncType kTestName = PetersonRGaussBandHorizontalSchemeRunFuncTestsProcesses::PrintFuncTestName;
