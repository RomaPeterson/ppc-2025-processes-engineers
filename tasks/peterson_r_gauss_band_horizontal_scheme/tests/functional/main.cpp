...
const auto kTestTasksList = std::tuple_cat(ppc::util::AddFuncTask<PetersonRGaussBandHorizontalSchemeMPI, InType>(
...
const auto kPerfTestName = PetersonRGaussBandHorizontalSchemeRunFuncTestsProcesses::PrintFuncTestName<
