...
class PetersonRGaussBandHorizontalSchemePerfTests
...
const auto kPerfTestName =
    PetersonRGaussBandHorizontalSchemePerfTests::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(
    RunModeTests,
    PetersonRGaussBandHorizontalSchemePerfTests,
    kGtestValues,
    kPerfTestName);
