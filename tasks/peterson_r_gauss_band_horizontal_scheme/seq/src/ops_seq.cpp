...
PetersonRGaussBandHorizontalSchemeSEQ::PetersonRGaussBandHorizontalSchemeSEQ(
...
bool PetersonRGaussBandHorizontalSchemeSEQ::ForwardElimination(InType& matrix, size_t n,
                                                              size_t cols) {
...
size_t PetersonRGaussBandHorizontalSchemeSEQ::ChoosePivotRow(const InType& matrix, size_t k,
                                                            size_t n) {
  size_t best_row = k;
...
void PetersonRGaussBandHorizontalSchemeSEQ::Eliminate(InType& matrix, size_t k, size_t n,
                                                     size_t cols) {
  for (size_t i = k + 1; i < n; ++i) {
