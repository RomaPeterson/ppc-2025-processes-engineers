...
PetersonRGaussBandHorizontalSchemeSEQ::PetersonRGaussBandHorizontalSchemeSEQ(const InType &in) {
...
bool PetersonRGaussBandHorizontalSchemeSEQ::ForwardElimination(InType &augmented_matrix, size_t n, size_t cols) {
...
size_t PetersonRGaussBandHorizontalSchemeSEQ::FindPivotRow(const InType &augmented_matrix, size_t k, size_t n) {
...
void PetersonRGaussBandHorizontalSchemeSEQ::EliminateColumn(InType &augmented_matrix, size_t k, size_t n, size_t cols) {
  for (size_t i = k + 1; i < n; ++i) {
...
std::vector<double> PetersonRGaussBandHorizontalSchemeSEQ::BackSubstitution(const InType &augmented_matrix, size_t n,
                                                                            size_t cols) {
